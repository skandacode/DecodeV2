...
@Configurable
@Autonomous(name = "AutoClose24", group = "Auto")
public class AutoStartCloseGatemodified24 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose shootPoseleave = new Pose(-20, -16*Posmultiplier, Math.toRadians(-23*Posmultiplier));
        ...
        Pose intake4Pose = new Pose(28,-56*Posmultiplier, Math.toRadians(0*Posmultiplier));
        Pose intake4donePose = new Pose(52, -64*Posmultiplier, Math.toRadians(0*Posmultiplier));
        Pose intake4Poseback = new Pose(48, -64*Posmultiplier, Math.toRadians(0*Posmultiplier));
        Pose intake4donePosemore = new Pose(58, -64*Posmultiplier, Math.toRadians(0*Posmultiplier));
        Pose intake5donePose = new Pose(30, -64*Posmultiplier, Math.toRadians(0*Posmultiplier));
        ...
        StateMachine autoMachine = new StateMachineBuilder() //Autonomia
                ...
                .onEnter(()->{
                    if (Posmultiplier==1) {
                        ...
                        shooter.setTurretPos(shooter.convertDegreestoServoPos(-73));
                    }                    shooter.setHood(0.54);
                ...
                .onEnter(()->{
                    ...
                    PathChain toIntake = follower.pathBuilder()
                            .addPath(new BezierLine(follower.getPose(), intake4donePose))
                            .setNoDeceleration()
                            .setTangentHeadingInterpolation()
                            .build();
...
*/
                ...
                .onEnter(()->{
                    ...
                    PathChain toScore = follower.pathBuilder()
                            .addPath(new BezierLine(follower.getPose(), shootPoseleave))
                            .setBrakingStrength(1.4)
                            .setTangentHeadingInterpolation()
                            .setReversed()
                            .build();
                ...
                .onEnter(()->{
                    ...
                    shooter.setUpperGateOpen(false);
                    PathChain toIntake = follower.pathBuilder()
                            .addPath(new BezierLine(follower.getPose(), intake5donePose))
                            .setNoDeceleration()
                            .setTangentHeadingInterpolation()
                            .build();
                    follower.followPath(toIntake, true);
