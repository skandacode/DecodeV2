...
//                .state(TeleopOnlyRapid.States.Intake)
//                .onEnter(() -> {
...
//                .state(TeleopOnlyRapid.States.OpenUpperGate)
//                .onEnter(() -> {
//                    intakes.setGoodIntakePower(intakeShooterVelo);
//                })
//                .transitionTimed(stallIntakeTime, TeleopOnlyRapid.States.P)
//                .state(TeleopOnlyRapid.States.PreShoot)
//                .onEnter(() -> {
//                    shooter.setUpperGateOpen(true);
//                })
//                .transitionTimed(0.1, TeleopOnlyRapid.States.Shoot)
//                .state(TeleopOnlyRapid.States.Shoot)
//                .onEnter(() -> {
//                    spindexer.setKickerPos(true);
//                })
//                .transitionTimed(openGateTime, TeleopOnlyRapid.States.Intake)
//                .build();
//
//
//        stateMachine.start();
