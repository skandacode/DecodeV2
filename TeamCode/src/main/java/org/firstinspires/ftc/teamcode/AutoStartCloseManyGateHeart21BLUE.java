...
//    PositionLogger positionLogger;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose gateintake1 = new Pose(9, -63, Math.toRadians(-110));
        Pose gateintake2 = new Pose(7, -63, Math.toRadians(-110));
        Pose gateintake3 = new Pose(7, -63, Math.toRadians(-110));
        Pose gateintake4 = new Pose(7, -63, Math.toRadians(-110));

        Pose gateintakecontrol = new Pose(8, -42, Math.toRadians(77));

        Pose startPose = new Pose(-44, -55, Math.toRadians(6));
        ...
        Pose intake1donePose = new Pose(-16, -52, Math.toRadians(-90));
        ...
        StateMachine autoMachine = new StateMachineBuilder() //Autonomia
                ...
                .onEnter(()->{
                    ...
                    shooter.setTurretPos(shooter.convertDegreestoServoPos(83));
                })
                ...
                .onEnter(()->{
                    intakes.setPower(1);
                    shooter.setTurretPos(shooter.convertDegreestoServoPos(71));
                    shooter.setHood(0.65);
                    shooter.setTargetVelocity(1320);
...
*/
                ...
                .onEnter(()->{
                    shooter.setTurretPos(shooter.convertDegreestoServoPos(84));
                    shooter.setHood(0.65);
                    shooter.setTargetVelocity(1330);
                    PathChain toScoreGate = follower.pathBuilder()
                            .addPath(new BezierLine(follower.getPose(), shootPose2nd))
