...
//        waitForStart();
//
//        Paths paths = new Paths(follower, alliance);
...
//                    follower.followPath(paths.intakeSpike1(), true);
//                })
//
...
//                .onEnter(()->{
//                    follower.followPath(paths.backToGate1(), true);
//                    intake.setPower(0);
//                })
//
//                .transition(()->follower.atParametricEnd())
...
//                    follower.followPath(paths.scoreGate1(), true);
//                })
//                .transitionTimed(1.5)
//
...
//                    transfer.setKicker(false);
//                    shooter.setUpperGate(false);
//                    follower.followPath(paths.intakeSpike2(), true);
//                })
//
//                .transition(()->follower.atParametricEnd())
//                .transitionTimed(1.1)
//                .transition(()-> intake.getBeamBreakOutside() && intake.getBeamBreakInside() && intake.getDetected())
//
//                .state(AutoStates.back2)
//                .onEnter(()->{
//                    follower.followPath(paths.backToGate2(), true);
//                })
//
//                .transitionTimed(0.3)
...
//
//                    follower.followPath(paths.scoreGate2(), true);
//                })
...
//                    transfer.setKicker(false);
//                    shooter.setUpperGate(false);
//                    follower.followPath(paths.intakeGate1(0.4), true);
//                })
//                .transition(()-> intake.getBeamBreakOutside() && intake.getBeamBreakInside() && intake.getDetected())
//                .transitionTimed(2.5)
//                /*
...
//                    shooter.setHood(0.54);
//                    shooter.setTargetVelocity(1440);
//                    follower.followPath(paths.scoreGate(), false);
//                })
//
//                .transition(()->follower.atParametricEnd())
//                .transitionTimed(1.5)
...
//                    transfer.setKicker(false);
//                    shooter.setUpperGate(false);
//                    follower.followPath(paths.intakeGate2(0.6), true);
//                })
//                .transition(()-> intake.getBeamBreakOutside() && intake.getBeamBreakInside() && intake.getDetected())
//                .transitionTimed(2.5)
//                /*
...
//                    transfer.setKicker(false);
//                    shooter.setUpperGate(false);
//                    follower.followPath(paths.intakeGate3(0.6), true);
//                })
//                .transition(()-> intake.getBeamBreakOutside() && intake.getBeamBreakInside() && intake.getDetected())
//                .transitionTimed(2.1)
...
//                    transfer.setKicker(false);
//                    shooter.setUpperGate(false);
//                    follower.followPath(paths.intakeGate4(0.6), true);
//                })
//                .transition(()-> intake.getBeamBreakOutside() && intake.getBeamBreakInside() && intake.getDetected())
//                .transitionTimed(2.5)
