...
//        telemetryM.debug("heading:" + follower.getPose().heading());
...
//        draw();
//
//        Vector heading = new Vector(1.0, follower.getPose().heading());
//        if (!end) {
//            if (!stopping) {
...
//        draw();
//
//        Vector heading = new Vector(1.0, follower.getPose().heading() - Math.PI / 2);
//        if (!end) {
//            if (!stopping) {
...
//    public static double kBrakeQuadratic = 0;
//    public static double kBrakeLinear = 0;
...
//            double forwardVelocity = Math.abs(follower.getVelocity().dot(new Vector(1, follower.heading())));
...
//            drawRobot(new Pose(closestPoint.getX(), closestPoint.getY(), follower.getCurrentPath().headingGoal(follower.getCurrentPath().getClosestPointTValue())), robotLook);
//        }
...
//        if (pose == null || Double.isNaN(pose.getX()) || Double.isNaN(pose.getY()) || Double.isNaN(pose.heading())) {
//            return;
//        }
//
...
//
//        Vector v = pose.headingAsUnitVector();
