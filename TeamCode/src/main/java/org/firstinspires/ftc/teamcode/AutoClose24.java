...
public class AutoClose24 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose gateintake5 = new Pose(3, -61*Posmultiplier, Math.toRadians(-110*Posmultiplier));
        ...
        StateMachine autoMachine = new StateMachineBuilder() //Autonomia
                ...
                .onEnter(()->{
                    ...
                    PathChain toScore2 = follower.pathBuilder()
                            .addPath(new BezierCurve(follower.getPose(), intake2Pose, shootPose2nd))
                            .setBrakingStrength(1)
                            .setTangentHeadingInterpolation()
                            .setReversed()
                            .build();
                ...
                .onEnter(()->{
                    ...
                    shooter.setUpperGateOpen(false);
                    PathChain toIntakeGate = follower.pathBuilder()
                            .addPath(new BezierCurve(follower.getPose(), gateintakecontrol,gateintake5))
                            .setLinearHeadingInterpolation(follower.getHeading(), gateintake5.getHeading())
                            .setBrakingStrength(0.6)
                            .build();
                    follower.followPath(toIntakeGate, true);
                })
